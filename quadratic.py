...
def display_handler(math_instance, ui, f_name, collection, x=1):
    ...
    if f_name == MathOps.exponential_function.__qualname__:
...
display_handler(math1, ui, MathOps.exponential_function.__qualname__, numbers_collection1)
...
display_handler(math2, ui, MathOps.exponential_function.__qualname__, numbers_collection2)
...
display_handler(math3, ui, MathOps.exponential_function.__qualname__, numbers_collection3)
...
display_handler(math4, ui, MathOps.exponential_function.__qualname__, numbers_collection4)
display_handler(math4, ui, MathOps.exponential_function.__qualname__, numbers_collection4)
